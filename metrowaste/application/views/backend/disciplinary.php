                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content ">
                                                ...
                                                <div class="modal-body">
				                                        ...
				                                        <input type="date" name="incidentdate" class="form-control" placeholder=""> 
				                                    </div>
                                                        <div class="form-group">
				                                        <label>Date Reported</label>
				                                        <input type="date" name="reporteddate" class="form-control" placeholder=""> 
				                                    </div>
                                                        <div class="form-group">
                                        ...
                                        $(document).ready(function () {
                                            $(".disiplinary").click(function (e) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    $('#btnSubmit').find('[name="reporteddate"]').val(response.desipplinary.reporteddate).end();
                                                    $('#btnSubmit').find('[name="incidentdate"]').val(response.desipplinary.incidentdate).end();
